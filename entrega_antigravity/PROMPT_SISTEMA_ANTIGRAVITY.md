# Prompt de sistema para Antigravity — EntreVoces

**Versión:** 1.1  
**Fecha:** 2026-08-18

El siguiente contenido puede utilizarse como `system_instruction` de un agente administrado de Antigravity o como instrucción principal para una IA que continúe el desarrollo. En la IDE, `AGENTS.md` aporta estas reglas automáticamente; se conserva este archivo para configuraciones administradas o portables.
...
- Mantiene `.agents/skills`, `.agents/rules` y `SKILL.md` porque Antigravity usa esas rutas para descubrir las Skills y reglas del espacio de trabajo.
