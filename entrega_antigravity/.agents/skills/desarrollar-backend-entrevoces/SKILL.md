...
Informar archivos modificados, contrato, migraciones, pruebas ejecutadas, resultado, riesgos y siguiente paso. Invocar la Skill `cerrar-modulo-entrevoces` cuando el módulo cumpla su criterio de aceptación.
