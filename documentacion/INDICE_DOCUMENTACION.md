...
7. [Guía de sesiones con Antigravity](GUIA_SESIONES_ANTIGRAVITY.md)  
   Indica cuándo abrir un chat nuevo, cómo iniciarlo y cómo verificar reglas, prompt y Skills sin modificar el proyecto.
