...
Registrar hardware, GPIO, alimentación, versión de MicroPython, comando de instalación y carga, salida REPL, resultado observable y siguiente prueba. Invocar `$diagnosticar-hardware-entrevoces` para fallos físicos y `$cerrar-modulo-entrevoces` al completar el módulo.
